...
public class DBSetup {
    private static final String DB_PATH = "Claves.sqlite";
    private static final String SQL_SCRIPT_DEV = "src/Cl/Burgos/Claves/SQL/Claves.sqlite.sql";
    private static final String SQL_SCRIPT_JAR = "/Cl/Burgos/Claves/SQL/Claves.sqlite.sql";
